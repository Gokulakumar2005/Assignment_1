                                                                ...
                                                                <div className="flex items-center gap-3">
                                                                    {component.image ? (
                                                                        <img
                                                                            src={component.image}
                                                                            alt={component.name}
                                                                            className="w-10 h-10 object-cover rounded-lg border border-slate-200 bg-white shrink-0 shadow-2xs"
                                                                            onError={(e) => {
                                                                    ...
                                                                    <div className="min-w-0">
                                                                        ...
                                                                        <div className="md:hidden text-xs text-slate-400 font-normal mt-0.5 truncate">{component.description}</div>
                                                                    </div>
                                                                </div>
                                                            </td>
